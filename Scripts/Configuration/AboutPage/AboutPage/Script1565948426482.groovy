...
WebUI.click(findTestObject('Object Repository/Conf/AboutPage/AboutPage/i_error'))

WebUI.verifyTextPresent('Version : 2.0.8.4', false)

WebUI.click(findTestObject('Object Repository/Conf/AboutPage/AboutPage/button_Close'))
