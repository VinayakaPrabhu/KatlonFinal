...
WebUI.setEncryptedText(findTestObject('Object Repository/Login_OR/Employee_login_verify/input_Username_mat-input-1'), GlobalVariable.employee_new_password)
