...
WebUI.verifyTextPresent('Cannot close the wallet with non-zero balance', false)

WebUI.click(findTestObject('Object Repository/Account/Wallet/Edit/Close/close/button_OK (1)'))

WebUI.click(findTestObject('Object Repository/Account/Wallet/Edit/Close/close/button_Cancel'))
