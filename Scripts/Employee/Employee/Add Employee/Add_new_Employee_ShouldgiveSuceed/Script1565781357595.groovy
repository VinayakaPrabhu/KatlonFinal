...
WebUI.setText(findTestObject('Object Repository/Employee/Employee/Add Employee_OR/Add_new_Employee_ShouldSucceed/input_Sign in_mat-input-0'), 
    GlobalVariable.username_admin)

WebUI.setEncryptedText(findTestObject('Object Repository/Employee/Employee/Add Employee_OR/Add_new_Employee_ShouldSucceed/input_Username_mat-input-1'), 
    GlobalVariable.username_admins_Password)

WebUI.click(findTestObject('Object Repository/Employee/Employee/Add Employee_OR/Add_new_Employee_ShouldSucceed/button_Login'))
